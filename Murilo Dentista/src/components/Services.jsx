...
function Services(){
    ...
    <div className="bg-bgServices" id="Services">
        <section className="grid grid-rows-3 place-content-center lg:place-content-center md:place-content-center sm:place-items-center pt-10 max-md:pt-6 max-md:px-3">
            <p className="text-ptext font-medium bg-bgP w-100 place-content-center text-center max-md:text-sm">Nossos Serviços</p>
            <h2 className="text-h1 font-bold text-2xl lg:text-5xl md:text-5xl sm:text-4xl w-100 lg:w-full md:w-full sm:w-full px-5 text-center max-md:text-xl max-md:px-2">Tratamentos completos para toda  a família</h2>

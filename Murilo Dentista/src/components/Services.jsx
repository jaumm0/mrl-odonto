...
function Services(){
    ...
    <div className="bg-bgServices" id="Services">
        <section className="grid grid-rows-3 place-items-center pt-10">
            <span className="text-ptext font-medium bg-bgP ">Nossos Serviços</span>
            <h2 className="text-h1 font-bold text-5xl place-items-center justify-content">Tratamentos completos para toda  a família</h2>
            <p className="text-pspan">Oferecemos uma ampla gama de serviços odontológicos com qualidade e tecnologia de ponta.</p>
        </section>
        <section className="pt-10">
            <ul className="grid grid-cols-3 w-full px-5  ">


                <div className="w-100 h-50 rounded-xl shadow-xl place-self-center mb-10 bg-bgIcons hover:scale-105 trasition-all duration-150">

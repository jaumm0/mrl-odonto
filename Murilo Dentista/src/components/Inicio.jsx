    ...
    return(
        <section className="grid grid-cols-2 gap-4 items-center px-10 py-10  bg-bginicio       " id="inicio">
            <div className=" flex flex-col gap-6 ">
                ...
                <h1 className="text-h1 text-2xl w-80  lg:w-full  lg:text-6xl md:text-6xl sm:text-5xl font-inter font-bold">Sorria com confiança. <br />Cuidado completo <br /> para você e sua <br /> família.</h1>
                <span className="text-pspan text-1xl w-80 lg:w-full  lg:text-2xl md:text-2xl sm:text-1xl pt-4 text-center lg:text-left md:text-justify sm:text-justify ">Há mais de 15 anos transformando sorrisos com tecnologia de ponta, profissionais especializados e atendimento humanizado.</span>
            <div className="flex  ">
                ...
                <a href="#Services"><button className=" border-borderb border-2 w-60 h-13 hidden lg:block md:block sm:hidden  rounded-xl px-4 py-2 cursor-pointer hover:bg-hoverBtn">Conhecer Serviços</button></a>
            </div>   
            <ul className="grid grid-cols-3 w-90 lg:w-full  gap-1 lg:text-2xl md:text-2xl sm:text-1xl pt-4 place-items-center ">
            ...
            <aside>
                <img src={dental} className="object-cover w-full rounded-xl block hidden lg:block md:block sm:hidden lg:w-full md:w-full sm:w-full " alt="Hero dental" />
            </aside>
        </section>

...
function Workon(){
    return(
        <section className="grid grid-cols-[47vh]  2xl:grid-cols-[87vh_1fr] lg:grid-cols-[90vh_1fr]  bg-bgServices place-self-center">
            ...
            <aside className='w-full lg:w-full px-2 mt-5 lg:px-0 md:px-0 sm:px-0 lg:mt-0 md:mt-0 sm:mt-0 pt-10 lg:pt-0 md:pt-0 sm:pt-0  max-md:mt-4'>
                    <div className='grid grid-cols-[9vh_1fr] max-md:grid-cols-[9vh_1fr]  max-md:grid-rows-[auto_1fr] mb-5 rounded-xl shadow-xl py-2 pl-2 max-md:py-4 max-md:px-2 bg-bgI w-20 lg:w-175 max-md:w-full h-30 lg:h-20 md:h-20 sm:h-20 max-md:min-h-0 hover:scale-105 trasition-all duration-150'>

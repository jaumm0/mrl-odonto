...
function Prefooter() {
    return(
        <div className="grid grid-rows-[1fr] lg:gap-6 pt-10 max-md:pt-6 max-md:px-4 bg-bgprefooter w-full lg:w-full text-white">
            ...
            <div className="grid grid-cols-[35vh_25vh] max-md:grid-cols-1 max-md:gap-3  lg:pl-10 py-5 lg:py-0 place-self-center max-md:pl-0 max-md:place-items-center">
               <a href="https://wa.me/5511999999999" className="max-md:w-full"> 
                <button target="_blank" className="w-90  text-center lg:w-80 md:w-80 sm:w-80 gap-2 bg-bgwhats h-13 lg:mr-5 rounded-xl px-10 py-2 cursor-pointer font-medium text-white hover:bg-hoverBtn max-md:w-full max-md:max-w-xs"> Agende sua consulta</button> </a>

...
function Prefooter() {
    return(
        <div className="grid grid-rows-[1fr] lg:gap-6 pt-10 max-md:pt-6 max-md:px-4 bg-bgprefooter w-full lg:w-full text-white">
            ...
            <div className="grid grid-cols-[40vh_25vh] max-md:grid-cols-1 max-md:gap-3 pl-4 lg:pl-10 py-5 lg:py-0 place-self-center max-md:pl-0 max-md:place-items-center">
               <a href="https://wa.me/5511999999999" className="max-md:w-full"> 

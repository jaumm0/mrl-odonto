...
function About(){
        return(
            <section className="grid grid-rows-[] lg:grid-cols-2  gap-10 lg:gap-30 items-center  py-10 max-md:py-6 bg-bgServices" id="About">
            
            <aside className='grid grid-rows-[30vh_] lg:grid-cols-[40vh_28vh] 2xl:grid-cols-[30vh_28vh] place-self-center lg:place-self-center 2xl:place-self-end md:place-end gap-10 max-md:justify-items-center max-md:mb-4'>
                <div className='w-77 h-50 rounded-xl bg-gradient-to-tr from-[#2253bd] to-[#48b4cf] shadow-xl place-self-center  hidden lg:block'>
                        <p className='text-7xl h-full place-self-center  place-content-center '>🦷</p>
                </div>  
                <div className='w-60 h-45 rounded-xl bg-coloraside shadow-xl hidden lg:block place-self-center '>
                        <p className='text-7xl h-full place-self-center  place-content-center '>💙</p>
                </div>
                   <div className='w-70 h-35 rounded-xl bg-coloraside shadow-xl hidden lg:block place-self-'>
                        <p className='text-7xl h-full place-self-center  place-content-center '>😊</p>
                </div>  
                <div className='w-70 h-65 rounded-xl bg-coloraside shadow-xl place-self-center  '>
                        <p className='text-7xl h-full place-self-center  place-content-center place-self-'>👨‍⚕️</p>
                </div>  
           
                
            </aside>
            
            <div className="grid grid-rows-[10vh_1fr] gap-6 pt-10 place-self-center max-md:pt-4 max-md:gap-4 2xl:pr-30 lg:pr-10 ">
                ...
                <span className="text-pspan text-1xl max-md:text-sm text-center px-5">Fundada com o compromisso de oferecer o melhor em odontologia, nossa clínica combina tecnologia avançada com um atendimento verdadeiramente humanizado. <p className="pt-3 max-md:pt-2 pb-5 lg:pb-0 md:pb-0 sm:pb-0">Nossa equipe é formada por profissionais apaixonados pelo que fazem, constantemente atualizados com as mais modernas técnicas e tratamentos disponíveis no mercado. Acreditamos que um sorriso bonito e saudável transforma vidas.</p></span>
            <section>
